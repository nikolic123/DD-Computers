...
<head>
    ...
    <title>DD Computers - Laptop - detalji</title>
...
if (isset($_GET['id'])) {
  ...
  $dynamicList = "";
  $sql = $connection->query("SELECT * FROM laptop WHERE id='$id' LIMIT 1");
  $productCount = mysqli_num_rows($sql); // count the output amount
    ...
    while($row = mysqli_fetch_array($sql)){ 
       ...
       $Cena = $row["Cena"];
       $Ekran = $row["Ekran"];
       $Dijagonala = $row["Dijagonala_ekrana"];
       $Rezolucija = $row["Rezolucija"];
       $procesor = $row["Procesor"];
       $cipset = $row["Cipset"];
       $Graficka_kartica = $row["Graficka_kartica"];
       $memorija = $row["Memorija"];
       $hard = $row["Hard_disk"];
       $tip_harda = $row["Tip_hard_diska"];
       $opticki_uredjaj = $row["Opticki_uredjaj"];
       $mrezna_kartica = $row["Mrezna_kartica"];
       $web_kamera = $row["Web_kamera"];
       $Bluetooth = $row["Bluetooth"];
       $baterija = $row["Baterija"];
       $citac = $row["Citac_kartica"];
       $op = $row["Operativni_sistem"];
       $boja = $row["Boja"];
       $slika=$row["slika"];
       $id=$row["id"];
...
?>
    <div class="container"><br>
      ...
      <li class="list-group-item"><h4>Cena:&nbsp;<?php echo $Cena; ?></h4></li>
...
<div class="col-12 col-md-12">
        <h6>Specifikacije laptopa:</h6><br>
  ...
  <tbody>
     <tr>
      ...
      <td>Ekran:</td>
      <td><?php echo $Ekran; ?></td>
  
    </tr>
     <tr>
      
      <td>Dijagonala ekrana:</td>
      <td><?php echo $Dijagonala; ?>"</td>
  
    </tr>
     <tr>
      
      <td>Rezolucija:</td>
      <td><?php echo $Rezolucija; ?></td>
  
    </tr>
    <tr>
      
      <td>Procesor:</td>
      <td><?php echo $procesor; ?></td>
  
    </tr>
     <tr>
      
      <td>Čipset:</td>
      <td><?php echo $cipset; ?></td>
  
    </tr>
     <tr>
      
      <td>Grafička kartica:</td>
      <td><?php echo $Graficka_kartica; ?></td>
  
    </tr>
    <tr>
      
      <td>Memorija:</td>
      <td><?php echo $memorija; ?></td>
     ...
     <tr>
      ...
      <td>Tip hard diska:</td>
      <td><?php echo $tip_harda; ?></td>
  
    </tr>
     <tr>
      
      <td>Optički uređaj:</td>
      <td><?php echo $opticki_uredjaj; ?></td>
  
    </tr>
     <tr>
      
      <td>Web kamera:</td>
      <td><?php echo $web_kamera; ?></td>
  
    </tr>
    <tr>
      
      <td>Mrežna kartica:</td>
      <td><?php echo $mrezna_kartica; ?></td>
