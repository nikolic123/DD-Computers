  ...
  <body>
   ...
   <a class="nav-link js-scroll-trigger text-uppercase" href="Kontakt.php">Kontakt</a>
    ...
    <div class="container"><br>
      <div class="row">
        <div class="col-md-5">
          <h6>Nemate nalog?<br><br> Regostruj se,veoma brzo cete napraviti nalog.</h6><br><br> <a href="Novi_nalog.php" class="btn" style="background-color: black;color: #fed136">Napravite nalog</a><br><br><br>
        </div>
        <div class="col-md-7">
    ...
    <div class="container">
       ...
       <form class="form-signin" method="post" id="login-form">
        ...
        <h2 class="form-signin-heading">Prijava korisnika</h2><hr />
        ...
        <div class="form-group">
            <button type="submit" class="btn" name="btnn-login" id="btnn-login" style="background-color: black;color: #fed136;">
