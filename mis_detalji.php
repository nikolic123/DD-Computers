...
<head>
    ...
    <title>DD Computers - Miš detalji</title>
...
if (isset($_GET['id'])) {
  ...
  $dynamicList = "";
  $sql = $connection->query("SELECT * FROM misevi WHERE id='$id' LIMIT 1");
...
<div class="col-12 col-md-12">
  ...
  <tbody>
     ...
     <tr>
      ...
      <td>Konekcija:</td>
      <td><?php echo $Konekcija; ?></td>
  
    </tr>
    <tr>
      
      <td>Dizajn:</td>
      <td><?php echo $Dizajn; ?></td>
