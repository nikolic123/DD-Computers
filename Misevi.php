...
<head>
    ...
    <div class="card-block">
     <div id='filters' class='sections'>
      ...
      <div class='filter-attributes col-6 col-md-12 '>
        ...
        <label class="con">Genius<input type='checkbox' name='Proizvodjac' id='Genius' value='Genius' ></input>
        <span class="checkmark"></span>
        </label>
        <label class="con">Logitech<input type='checkbox' name='Proizvodjac' id='Logitech' value='Logitech' ></input>
        <span class="checkmark"></span>
        </label><hr>
      </div>
  ...
  <?php 
      $dynamicList = "";
      $sql = $connection->query("SELECT * FROM misevi ");
      ...
      <div class="card-block">
      <h6 class="card-title" style="font-size:13px;height:80px">'.$Naziv.'</h6>
      <hr><p>Cena:<br>  <b>'.$Cena.'&nbsp;RSD</b> </p>  
      </div><a href="mis_detalji.php?id=' . $id . '" style="text-decoration:none">
