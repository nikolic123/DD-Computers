...
<head>
    ...
    <div class="card-block">
     <div id='filters' class='sections'>
      ...
      <div class='filter-attributes col-6 col-md-12 '>
        ...
        <label class="con">Asus<input type='checkbox' name='Proizvodjac' id='Asus' value='Asus' ></input>
        <span class="checkmark"></span>
        </label>
        <label class="con">Acer<input type='checkbox' name='Proizvodjac' id='Acer' value='Acer' ></input>
        <span class="checkmark"></span>
        </label>
       ...
       <div class='filter-attributes col-6 col-md-12'>
        <p style="font-size: 90%;font-weight: bold">Dijagonala ekrana</p><hr>
        <label class="con">13.3"<input type='checkbox' name='dijagonala' id='13.3' value='13.3' ></input>
        <span class="checkmark"></span>
        </label>
        <label class="con">14"<input type='checkbox' name='dijagonala' id='14' value='14' ></input>
        <span class="checkmark"></span>
        </label>
        <label class="con">15.6"<input type='checkbox' name='dijagonala' id='15.6' value='15.6' ></input>
        <span class="checkmark"></span>
        </label>
        <label class="con">17.3"<input type='checkbox' name='cdijagonala' id='17.3' value='17.3' ></input>
        <span class="checkmark"></span>
        </label><hr>
      </div>
       <div class='filter-attributes col-6 col-md-12'>
        <p style="font-size: 90%;font-weight: bold">Procesor</p><hr>
        <label class="con">Intel Core i3<input type='checkbox' name='Procesor' id='Intel Core i3' value='Intel Core i3' ></input>
        <span class="checkmark"></span>
        </label>
        <label class="con">Intel Core i5<input type='checkbox' name='Procesor' id='Intel Core i5' value='Intel Core i5' ></input>
        <span class="checkmark"></span>
        </label>
        <label class="con">Intel Core i7<input type='checkbox' name='Procesor' id='Intel Core i7' value='Intel Core i7' ></input>
        <span class="checkmark"></span>
        </label>
        <label class="con">Intel Pentium<input type='checkbox' name='Procesor' id='Intel Pentium' value='Intel Pentium' ></input>
        <span class="checkmark"></span>
        </label>
        <label class="con">Intel Celeron<input type='checkbox' name='Procesor' id='Intel Celeron' value='Intel Celeron' ></input>
        <span class="checkmark"></span>
        </label>
        <hr>
      </div>
       <div class='filter-attributes col-6 col-md-12'>
        <p style="font-size: 90%;font-weight: bold">Rezolucija</p><hr>
        <label class="con">1366 x 768 piksela<input type='checkbox' name='Rezolucija' id='1366 x 768 piksela' value='1366 x 768 piksela' ></input>
        <span class="checkmark"></span>
        </label>
        <label class="con">1440 x 900 piksela<input type='checkbox' name='Rezolucija' id='1440 x 900 piksela' value='1440 x 900 piksela' ></input>
        <span class="checkmark"></span>
        </label>
        <label class="con">1600 x 900 piksela<input type='checkbox' name='Rezolucija' id='1600 x 900 piksela' value='1600 x 900 piksela' ></input>
        <span class="checkmark"></span>
        </label>
        <label class="con">1920 x 1080 piksela<input type='checkbox' name='Rezolucija' id='1920 x 1080 piksela' value='1920 x 1080 piksela' ></input>
        <span class="checkmark"></span>
        </label>
        <label class="con">2304 x 1440 piksela<input type='checkbox' name='Rezolucija' id='2304 x 1440 piksela' value='2304 x 1440 piksela' ></input>
        <span class="checkmark"></span>
        </label>
        <label class="con">2560 x 1440 piksela<input type='checkbox' name='Rezolucija' id='2560 x 1440 piksela' value='2560 x 1440 piksela' ></input>
        <span class="checkmark"></span>
        </label>
        <label class="con">3840 x 2160 piksela<input type='checkbox' name='Rezolucija' id='3840 x 2160 piksela' value='3840 x 2160 piksela' ></input>
        <span class="checkmark"></span>
        </label><hr>
      </div>
      <div class='filter-attributes col-6 col-md-12'>
        <p style="font-size: 90%;font-weight: bold">Grafička kartica</p><hr>
        <label class="con">Integrisana<input type='checkbox' name='colour' id='red' value='red' ></input>
        <span class="checkmark"></span>
        </label>
        <label class="con">Neintegrisana<input type='checkbox' name='colour' id='red' value='red' ></input>
        <span class="checkmark"></span>
        </label><hr>
      </div>
      <div class='filter-attributes col-6 col-md-12'>
        <p style="font-size: 90%;font-weight: bold">Vrsta diska</p><hr>
        <label class="con">HDD<input type='checkbox' name='disk' id='HDD' value='HDD' ></input>
        <span class="checkmark"></span>
        </label>
        <label class="con">SSD<input type='checkbox' name='disk' id='SDD' value='SSD' ></input>
        <span class="checkmark"></span>
        </label><hr>
      </div>
      <div class='filter-attributes col-6 col-md-12'>
        <p style="font-size: 90%;font-weight: bold">Memorija</p><hr>
        <label class="con">4GB<input type='checkbox' name='RAM' id='4GB' value='4GB' ></input>
        <span class="checkmark"></span>
        </label>
        <label class="con">8GB<input type='checkbox' name='RAM' id='8GB' value='8GB' ></input>
        <span class="checkmark"></span>
        </label>
        <hr>
      </div>
  ...
  <?php 
      $dynamicList = "";
      $sql = $connection->query("SELECT * FROM laptop ");
      $productCount = mysqli_num_rows($sql); // count the output amount
      if ($productCount > 0) {
      while($row = mysqli_fetch_array($sql)){ 
       $id = $row["id"];
       $Pun_naziv = $row["Pun_naziv"];
       $Cena = $row["Cena"];
       $Slika = $row["slika"];
        $Procesor = $row["Procesor"];
        $tip=$row["Tip_hard_diska"];
      ...
      <div class="card col-6 col-md-3 grid-products "  data-Proizvodjac="'.$Proizvodjac.'" data-RAM="'.$Memorija.'" data-disk="'.$tip.'" data-Rezolucija="'.$Rezolucija.'" data-dijagonala="'.$Dijagonala_ekrana.'" data-Procesor="'.$Procesor.'" style="padding-bottom: 10px;">
