...
if(isset($_POST['btn-signup'])) {
    ...
    $adresa = $connection->real_escape_string($adresa);
    $telefon = $connection->real_escape_string($telefon);

    
    $hashed_password = password_hash($upass, PASSWORD_DEFAULT); // this function works only in PHP 5.5 or latest version
    
    $check_email = $connection->query("SELECT email FROM korisnici WHERE email='$email'");
    $count=$check_email->num_rows;
    
    if ($count==0) {
        
        $query = "INSERT INTO korisnici(ime,email,password,Adresa,Telefon) VALUES('$uname','$email','$hashed_password','$adresa','$telefon')";
        ...
        $msg = "<div class='alert alert-danger'>
                    <span class='glyphicon glyphicon-info-sign'></span> &nbsp; Žao nam je ali email je već zauzet !
                </div>";
...
<div class="signin-form">
    ...
    <div class="container">
      ...
      <br>
        <h2 class="form-signin-heading">Pravljenje novog naloga</h2><hr />
        ...
        <div class="form-group">
        <input type="email" class="form-control" placeholder="Email adresa" name="email" required  />
        ...
        <input type="password" class="form-control" placeholder="Password" name="password" required  />
          ...
          <div class="form-group">
        <input type="text" class="form-control" placeholder="Adresa isporuke" name="Adresa" required  />
        </div>
          <div class="form-group">
        ...
        <div class="form-group">
            ...
            <a href="Placanje.php" class="btn btn-primary" style="float:right;">Prijavi se</a>
        </div> 
