...
<head>
  ...
  <?php 
      $dynamicList = "";
      $sql = $connection->query("SELECT * FROM torbe ");
      ...
      <div class="card col-6 col-md-3 grid-products "  data-Proizvodjac="'.$Proizvodjac.'"  data-Veličina="'.$Veličina.'" style="padding-bottom: 10px;">
