...
<?php include ("db_config.php");
 $id=$_GET["id"];
  $sql="SELECT * FROM slusalice WHERE id=$id";
...
$row=mysqli_fetch_array($result);
   ...
   ?>
    ...
    <form method="POST" action="Slusalice_sacuvaj_promenu.php">
    ...
    <li class="list-group-item"><b>Sistem:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Sistem" value="<?php echo $row["Sistem"] ?>"></li>
    <li class="list-group-item"><b>Mikrofon:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Mikrofon" value="<?php echo $row["Mikrofon"] ?>"></li>
    <li class="list-group-item"><b>Frekventni odziv:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Frekventni_odziv" value="<?php echo $row["Frekventni_odziv"] ?>"></li>
