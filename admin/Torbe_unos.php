...
<div class="card"><br>
    <h4>&nbsp;Unesite novu torbu:</h4><hr>
    <form method="POST" action="Torbe_nov.php">
    ...
    <li class="list-group-item"><b>Veličina:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Veličina" ></li>
    <li class="list-group-item"><b>Razno:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Razno" ></li>
    <li class="list-group-item"><b>Slika:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="slika" ></li>

    <input type="hidden" value="8" name="grupa" ></li>
