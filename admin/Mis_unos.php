...
<div class="card"><br>
    <h4>&nbsp;Unesite novi miš:</h4><hr>
    <form method="POST" action="Mis_nov.php">
    ...
    <li class="list-group-item"><b>Senzor:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Senzor" ></li>
    <li class="list-group-item"><b>Rezolucija:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Rezolucija" ></li>
    <li class="list-group-item"><b>Dizajn:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Dizajn" ></li>
    ...
    <input type="hidden" value="2" name="grupa" ></li>
