...
$row=mysqli_fetch_array($result);
   ...
   ?>
    ...
    <div class="card"><br>
    <h4>&nbsp;Promenite elemente određenog artikla</h4><hr>
    <form method="POST" action="sacuvaj.php">

        <ul class="list-group list-group-flush">
    <li class="list-group-item"><b>Ime Artikla:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Pun_naziv" value="<?php echo $row["Pun_naziv"] ?>"></li>
    <li class="list-group-item"><b>Cena:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Cena" value="<?php echo $row["Cena"] ?>"></li>
    <li class="list-group-item"><b>Ekran:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Ekran" value="<?php echo $row["Ekran"] ?>"></li>
    <li class="list-group-item"><b>Dijagonala ekrana:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Dijagonala_ekrana" value="<?php echo $row["Dijagonala_ekrana"] ?>"></li>
    <li class="list-group-item"><b>Rezolucija:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Rezolucija" value="<?php echo $row["Rezolucija"] ?>"></li>
    <li class="list-group-item"><b>Procesor:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Procesor" value="<?php echo $row["Procesor"] ?>"></li>
    <li class="list-group-item"><b>Cipset:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Cipset" value="<?php echo $row["Cipset"] ?>"></li>
    <li class="list-group-item"><b>Graficka kartica:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Graficka_kartica" value="<?php echo $row["Graficka_kartica"] ?>"></li>
    <li class="list-group-item"><b>Memorija:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Memorija" value="<?php echo $row["Memorija"] ?>"></li>
    <li class="list-group-item"><b>Hard disk:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Hard_disk" value="<?php echo $row["Hard_disk"] ?>"></li>
    <li class="list-group-item"><b>Tip hard diska:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Tip_hard_diska" value="<?php echo $row["Tip_hard_diska"] ?>"></li>
    <li class="list-group-item"><b>Opticki uredjaj:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Opticki_uredjaj" value="<?php echo $row["Opticki_uredjaj"] ?>"></li>
    <li class="list-group-item"><b>Web kamera:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Web_kamera" value="<?php echo $row["Web_kamera"] ?>"></li>
    <li class="list-group-item"><b>Mrezna kartica:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Mrezna_kartica" value="<?php echo $row["Mrezna_kartica"] ?>"></li>
    <li class="list-group-item"><b>Bluetooth:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Bluetooth" value="<?php echo $row["Bluetooth"] ?>"></li>
    <li class="list-group-item"><b>Citac kartica:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Citac_kartica" value="<?php echo $row["Citac_kartica"] ?>"></li>
    <li class="list-group-item"><b>Operativni_sistem:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Operativni_sistem" value="<?php echo $row["Operativni_sistem"] ?>"></li>
    <li class="list-group-item"><b>Boja:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Boja" value="<?php echo $row["Boja"] ?>"></li>
    <li class="list-group-item"><b>Baterija:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Baterija" value="<?php echo $row["Baterija"] ?>"></li>
    <li class="list-group-item"><b>slika:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="slika" value="<?php echo $row["slika"] ?>"></li>
    
    

    <li class="list-group-item"><input type="hidden" name="id" value="<?php echo $id?>">
<button type="submit" class="btn btn-primary">Promeni </button></li>
