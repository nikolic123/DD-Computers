...
<?php include ("db_config.php");
 $id=$_GET["id"];
  $sql="SELECT * FROM misevi WHERE id=$id";
...
$row=mysqli_fetch_array($result);
   ...
   ?>
    ...
    <form method="POST" action="Mis_sacuvaj_promenu.php">
    ...
    <li class="list-group-item"><b>Senzor:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Senzor" value="<?php echo $row["Senzor"] ?>"></li>
    <li class="list-group-item"><b>Rezolucija:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Rezolucija" value="<?php echo $row["Rezolucija"] ?>"></li>
    <li class="list-group-item"><b>Dizajn:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Dizajn" value="<?php echo $row["Dizajn"] ?>"></li>
