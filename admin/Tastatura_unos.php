...
<div class="card"><br>
    <h4>&nbsp;Unesite novu tastaturu:</h4><hr>
    <form method="POST" action="Tastatura_nov.php">
    ...
    <li class="list-group-item"><b>Numerički deo:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Numericki_deo" ></li>
    <li class="list-group-item"><b>Miš:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="mis" ></li>
    <li class="list-group-item"><b>Konekcija:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="konekcija" ></li>
    <li class="list-group-item"><b>Dimenzije:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="dimenzije" ></li>
    <li class="list-group-item"><b>Boja:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Boje" ></li>
    <li class="list-group-item"><b>Slika:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="slika" ></li>

    <input type="hidden" value="7" name="grupa" ></li>
