...
<?php include ("db_config.php");
 $id=$_GET["id"];
  $sql="SELECT * FROM torbe WHERE id=$id";
...
$row=mysqli_fetch_array($result);
   ...
   ?>
    ...
    <form method="POST" action="Torbe_sacuvaj_promenu.php">
    ...
    <li class="list-group-item"><b>Veličina:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Veličina" value="<?php echo $row["Razno"] ?>"></li>
    <li class="list-group-item"><b>Razno:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Razno" value="<?php echo $row["Razno"] ?>"></li>
