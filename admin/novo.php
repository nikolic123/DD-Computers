...
<div class="card"><br>
    <h4>&nbsp;Unesite novi laptop:</h4><hr>
    <form method="POST" action="novi_unos.php">

    <ul class="list-group list-group-flush">
    <li class="list-group-item"><b>Ime Artikla:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Pun_naziv" ></li>
    <li class="list-group-item"><b>Cena:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Cena" ></li>
    <li class="list-group-item"><b>Ekran:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Ekran" ></li>
    <li class="list-group-item"><b>Dijagonala ekrana:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Dijagonala_ekrana" ></li>
    <li class="list-group-item"><b>Rezolucija:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Rezolucija" ></li>
    <li class="list-group-item"><b>Procesor:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Procesor" ></li>
    <li class="list-group-item"><b>Cipset:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Cipset" ></li>
    <li class="list-group-item"><b>Grafička kartica:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Graficka_kartica" ></li>
    <li class="list-group-item"><b>Memorija:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Memorija" ></li>
    <li class="list-group-item"><b>Hard disk:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Hard_disk" ></li>
    <li class="list-group-item"><b>Tip hard diska:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Tip_hard_diska" ></li>
    <li class="list-group-item"><b>Optički uređaj:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Opticki_uredjaj" ></li>
    <li class="list-group-item"><b>Web kamera:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Web_kamera" ></li>
    <li class="list-group-item"><b>Mrežna kartica:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Mrezna_kartica" ></li>
    <li class="list-group-item"><b>Bluetooth:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name=" Bluetooth" ></li>
    <li class="list-group-item"><b>Čitač kartica:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Citac_kartica" ></li>
    <li class="list-group-item"><b>Operativni sistem:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Operativni_sistem" ></li>
    <li class="list-group-item"><b>Boja:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Boja" ></li>
    <li class="list-group-item"><b>Baterija:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Baterija" ></li>
    <li class="list-group-item"><b>Slika:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="slika" ></li>
    <input type="hidden" value="1" name="grupa" ></li>
