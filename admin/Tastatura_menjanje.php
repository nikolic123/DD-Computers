...
<?php include ("db_config.php");
 $id=$_GET["id"];
  $sql="SELECT * FROM tastature WHERE id=$id";
...
$row=mysqli_fetch_array($result);
   ...
   ?>
    ...
    <form method="POST" action="Tastatura_sacuvaj_promenu.php">

        <ul class="list-group list-group-flush">
    <li class="list-group-item"><b>Ime Artikla:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Naziv" value="<?php echo $row["Naziv"] ?>"></li>
    <li class="list-group-item"><b>Cena:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Cena" value="<?php echo $row["Cena"] ?>">&nbsp;RSD</li>
    <li class="list-group-item"><b>Numerički deo:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Numericki_deo" value="<?php echo $row["Numericki_deo"] ?>"></li>
    <li class="list-group-item"><b>Miš:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="mis" value="<?php echo $row["mis"] ?>"></li>
    <li class="list-group-item"><b>Konekcija:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="konekcija" value="<?php echo $row["konekcija"] ?>"></li>
    <li class="list-group-item"><b>Dimenzije:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="dimenzije" value="<?php echo $row["dimenzije"] ?>"></li>
    <li class="list-group-item"><b>Boja:</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Boje" value="<?php echo $row["Boje"] ?>"></li>
